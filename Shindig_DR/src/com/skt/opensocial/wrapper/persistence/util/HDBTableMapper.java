...
public class HDBTableMapper {
	...
	public static List<Url> getUrlListFromUrlDBSet(Set<com.skt.opensocial.persistence.PersonUrl> urlDBSet) {
		List<Url> urlList = new ArrayList<Url>();
		
		for (com.skt.opensocial.persistence.PersonUrl urlDB : urlDBSet) {
			Url url = new UrlImpl();
	...
	public static Map<String, String> getAppDataMapFromAppDataDBSet(Set<com.skt.opensocial.persistence.PersonAppData> appDataDBSet) {
		Map<String, String> appDataMap = new HashMap<String, String>();
		
		for (com.skt.opensocial.persistence.PersonAppData appDataDB : appDataDBSet) {
	...
	public static List<Organization> getOrganizationListFromOrganizationDBSet(Set<com.skt.opensocial.persistence.PersonOrganization> organizationDBSet) {
		List<Organization> organizationList = Lists.newArrayList();
		
		for(com.skt.opensocial.persistence.PersonOrganization organizationDB : organizationDBSet) {
