...
<table height="100" width="200">
	<tr>
		<td colspan="2">삭제된 가젯(<s:property value="gadgetId"/>)은 복구되지 않습니다.</td>
	...
	<tr>
		...
		<td><s:submit value="삭제" onclick="opener.location.href='%{userRemoveGadgetUrl}';window.close()" ></s:submit>
		</td>		
